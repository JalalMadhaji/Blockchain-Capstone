...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), 'Is not a real address');
        _owner = newOwner;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, 'This address is the owner of the token');

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(_tokenOwner[tokenId],msg.sender), 'The caller should be the owner or is approved');
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(_exists(tokenId),'Token is not approved');
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, 'Caller can`t approve himself');
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), 'tokenId is already exist');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from, 'caller is not the owner of this tokenId');
...
contract CustomERC721Token is ERC721Metadata('TestName','TN','https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/'){
